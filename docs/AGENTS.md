...
- `superpowers/specs/2026-09-23-codex-study-exploration-design.md`: whole-view/series observations and voice-independent Codex use of native viewer tools. Written design approved by the user on 2026-09-23; implemented on the study-exploration branch, with release and acceptance tracked in the study exploration runbook. Includes scope grants, tool parity, full versus partial frame coverage, action receipts, takeover and native/subscription acceptance.
