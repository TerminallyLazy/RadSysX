...
- `ai-backend/OPENMED_ADAPTATIONS.md` maps the native metadata, literal report-structuring and PubMed-mining tools to their requested OpenMed workflows, including active execution paths and deferred NER/SR/full-text scope.
